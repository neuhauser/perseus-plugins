...
namespace PerseusPluginLib.Combine{
	public class MatchingColumnsByName : IMatrixCombination{
		...
		public IMatrixData CombineData(IMatrixData mdata1, IMatrixData mdata2, Parameters param, ProcessInfo processInfo){
